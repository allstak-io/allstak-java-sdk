...
/**
 * Connection wrapper that returns instrumented Statement and PreparedStatement instances.
...
class InstrumentedConnection implements Connection {
    ...
    InstrumentedConnection(Connection delegate, AllStakClient client, String databaseType, String databaseName) {
    ...
    // ---- Instrumented factory methods ----

    @Override
    public Statement createStatement() throws SQLException {
        return new InstrumentedStatement(delegate.createStatement(), client, databaseType, databaseName);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new InstrumentedStatement(delegate.createStatement(resultSetType, resultSetConcurrency), client, databaseType, databaseName);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new InstrumentedStatement(delegate.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql), sql, client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql, resultSetType, resultSetConcurrency), sql, client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sql, client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql, autoGeneratedKeys), sql, client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql, columnIndexes), sql, client, databaseType, databaseName);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new InstrumentedPreparedStatement(delegate.prepareStatement(sql, columnNames), sql, client, databaseType, databaseName);
    }
